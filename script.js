...
const jobWordEl = document.getElementById('jobWord');
const jobSelect = document.getElementById('jobRole');
const taskInput = document.getElementById('taskType');
const datalist = document.getElementById('taskSuggestions');
const showDefaultBtn = document.getElementById('showDefault');
const aiShortcutBtn = document.getElementById('fetchAI');
const generateInsightBtn = document.getElementById('generateInsight');
const toolList = document.getElementById('toolList');
const helpText = document.querySelector('.results .help-text');
...
function openJobScreen() {
  if (!jobScreen || !mainShell) return;
  if (jobScreen.classList.contains('job-screen--visible')) return;

  mainShell.classList.add('main-shell--hidden');
  jobScreen.hidden = false;
  jobScreen.setAttribute('aria-hidden', 'false');

  requestAnimationFrame(() => {
    jobScreen.classList.add('job-screen--visible');
  });

  logoTrigger?.classList.add('logo-trigger--hidden');
...
if (jobScreen) {
  jobScreen.hidden = true;
  jobScreen.setAttribute('aria-hidden', 'true');
}

if (logoTrigger) {
  logoTrigger.addEventListener('click', openJobScreen);
